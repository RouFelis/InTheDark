...
namespace InTheDark.LoremIpsum
{
	...
	public static class MEMO
	{
		...
		// 몬스터 공격 모션 진행 중 플레이어가 (죽거나) 범위 밖으로 이탈하거나 몬스터 사망 시 Damage 안 들어가게 수정
		// 플레이어 사망 시 대상 해제
		...
		// 돌진 충돌 시 플레이어 반대방향으로 밀리게 -> 해오라꼬!!!!! -> 충돌방식 변경
		...
		// 체력 / Damage 상관 없이 무조건 두 방
		// 스킬 사용 시 방향 조정 하기

		// 몬스터 생성 조건 추가
		// 1. 퀘스트 클리어 시 생성 시작
		// 2. 3에리어 까지만 그런방식으로 진행
		// 3 3에리어 부터는 몬스터가 처음부터 나오지만 퀘스트가 진행 될 수록 많이 나오도록 설정
		// -> 퀘스트 완료 델리게이트 추가해서 적용하기

		// 조명 설정 -> Exposure

		// 거미 미니언 안 움직이는 문제 수정하기
