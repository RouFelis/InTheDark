Shader "Hidden/Shader/Glitch2Effect_RLPRO"
{
		 Properties
    {
        ...
        _trashFrame1("trash Texture1", 2DArray) = "grey" {}
        _trashFrame2("trash Texture2", 2DArray) = "grey" {}
    }
	HLSLINCLUDE
	...
	float4 Frag(Varyings i) : SV_Target
	{
		...
		float4 source = SAMPLE_TEXTURE2D_X_LOD(_MainTex,s_point_clamp_sampler, uv,0);
		float3 color = lerp(source, LOAD_TEXTURE2D_X(_TrashTex, uv), w_f).rgb;
