...
namespace UnityEditor.Rendering.HighDefinition
{
	...
	[CustomEditor(typeof(Bleed_RLPRO_HDRP))]
#else
[VolumeComponentEditor(typeof(Bleed_RLPRO_HDRP))]
	...
	internal sealed class Bleed_RLPRO_HDRP_Editor : VolumeComponentEditor
	{
		...
		SerializedDataParameter m_resolutionFactor;
		...
		public override void OnEnable()
		{
            ...
            m_resolutionFactor = Unpack(o.Find(x => x.resolutionFactor));
		...
		public override void OnInspectorGUI()
		{
			...
			PropertyField(m_resolutionFactor);
