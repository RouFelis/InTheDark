...
[Serializable, VolumeComponentMenu(" Retro Look Pro/VHS")]
public sealed class VHS_RLPRO : CustomPostProcessVolumeComponent, IPostProcessComponent
{
    ...
    public override void Render(CommandBuffer cmd, HDCamera camera, RTHandle source, RTHandle destination)
    {
		...
		m_Material.SetFloat("smooth1",  smoothCut.value ? 1 : 0);
        ...
        cmd.Blit(source, destination, m_Material, (int)blendMode.value);
